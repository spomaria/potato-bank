        ...
        <div>
            <div className="about">
                <div className="potato about-div divs">
                    ...
                    <br />
                    <p>We intend to leavearage on Potato to achieve some Sustainable Development Goals (SDG)</p>
                </div>
                <div className="farmer about-div divs">
                    ...
                    <br />
                    <p>The farmer becomes richer, poverty is eliminated (SDG 1). Also, we make available more ware potato thereby reducing hunger (SDG 2).</p>
                </div>
                <div className="consumer about-div divs">
                    ...
                    <br />
                    <p>Also, we promote responsible production and consumption (SDG 12)by ensuring that potato is put into good use irrespective of size or variety. This is achieved through processing.</p>
                </div>
                <div className="about-div">
                    <h1>Summary</h1><br />
                    <ul>
                        <li>SDG 1 & 2: <br />The farmer receives fair wage for production while the consumer gets value for money paid. Thus poverty and hunger are eliminated</li> <br />
                        <li>SDG 12: <br /> Responsible Consumption and Production is promoted through the reduction of post harvest losses</li> <br />
                        <li>SDG 3: <br />Good Health and Wellbeing is achieved by default when SDG Goals 1, 2 and 12 are achieved.<br /></li>
                    </ul>
